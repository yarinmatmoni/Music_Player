...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Player setCurrentSong={setCurrentSong} songs={songs} songInfo={songInfo}  audioRef={audioRef} currentSong={currentSong} isPlaying={isPlaying} setIsPlaying={setIsPlaying}  />
